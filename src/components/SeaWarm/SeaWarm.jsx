      ...
      <div className="sea__inner container">
        ...
        {ready && sel && (
          <div className="sea__stage">
            {/* L'INSTRUMENT — l'océan, le thermomètre, et les commandes posées dessus. */}
            <figure className="sea__viz">
              ...
              {/* ============================================================
                  LES COMMANDES, POSÉES SUR L'INSTRUMENT
                  ------------------------------------------------------------
                  Le sélecteur et les deux extrêmes vivaient dans une colonne à
                  gauche du dessin : trois blocs de même poids, dont aucun ne
                  disait lequel regarder. Or il n'y a ici qu'un seul objet — le
                  thermomètre. Tout le reste le commande ou le commente.

                  Ils reviennent donc DANS le cadre, aux endroits que le dessin
                  laisse vides : le territoire dans le ciel, en haut à gauche,
                  là où l'œil entre ; le plus chaud EN HAUT et le plus frais EN
                  BAS, du côté des graduations. Cette dernière position n'est pas
                  décorative : sur un thermomètre, le chaud est en haut. Les deux
                  pastilles se lisent à la hauteur qu'elles désignent.
                  ============================================================ */}
              <div className="sea__overlay">
                ...
                {extremes && (
                  ...
                  <div className="sea__chips">
                    {[
                      ...
                      <div
                        key={key}
                        className={`sea__chipwrap sea__chipwrap--${key}`}
                      ...
                      >
                        ...
                        >
                          <span className="sea__chip-lab">{label}</span>
            ...
            {/* LA LECTURE — le nombre, le territoire, la tendance. */}
